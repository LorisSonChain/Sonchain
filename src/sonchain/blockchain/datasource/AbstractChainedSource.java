...
public abstract class AbstractChainedSource<Key, Value, SourceKey, SourceValue> 
			implements Source<Key, Value> {

	public static final Logger m_logger = Logger.getLogger(AbstractChainedSource.class);
