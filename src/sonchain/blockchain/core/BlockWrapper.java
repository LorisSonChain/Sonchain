...
public class BlockWrapper {
    ...
    private SonChainHostInfo m_hostInfo = null;

    
    public BlockWrapper(Block block, SonChainHostInfo hostInfo) {
        this(block, false, hostInfo);
    }
    
    public BlockWrapper(Block block, boolean newBlock, SonChainHostInfo hostInfo) {
    	m_block = block;
    	m_newBlock = newBlock;
    	m_hostInfo = hostInfo;
    }
    ...
    private void parse(byte[] bytes) {
        ...
        m_hostInfo = SonChainHostInfo.fromBytes(nodeBytes);
    }
    ...
    public boolean sentBy(SonChainHostInfo hostInfo) {
    	if(m_hostInfo.m_ip.equals(hostInfo.m_ip) 
    			&& m_hostInfo.m_serverPort == hostInfo.m_serverPort){
    		return true;
    	}
        return false;
    }
