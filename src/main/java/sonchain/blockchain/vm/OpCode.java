...
public enum OpCode {
    ...
    /**
     * (0x41) Get the block coinbase address
     */
    COINBASE(0x41, 0, 1, Tier.BaseTier),
    /**
     * (x042) Get the block timestamp
     */
    TIMESTAMP(0x42, 0, 1, Tier.BaseTier),
    /**
     * (0x43) Get the block number
     */
     ...
     */
    CALL(0xf1, 7, 1, Tier.SpecialTier),     //       [out_data_size] [out_data_start] [in_data_size] [in_data_start] [value] [to_addr]
    // [gas] CALL
    /**
     * (0xf2) Calls self, but grabbing the code from the
     * TO argument instead of from one's own address
     */
    CALLCODE(0xf2, 7, 1, Tier.SpecialTier),
    /**
     ...
     */
    DELEGATECALL(0xf4, 6, 1, Tier.SpecialTier),
    /**
