...
//    }
    ...
    public List<Transaction> call() throws Exception {
        ...
        try {
        	m_logger.debug("sendTransaction tx: {}" + m_tx.toString());
			TransactionsMessage transactionsMessage = new TransactionsMessage(m_tx);
        	DataCenter.getNodeManager().sendTransactionsMessage(transactionsMessage);
